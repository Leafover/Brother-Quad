...
public class LightningBolt {
	...
	public void Init(int lineRendererCount, GameObject lineRendererPrefab, GameObject lightRendererPrefab,GameObject parent){
		...
		for(int i=0;i<lineRendererCount;i++){
            ...
            lineRenderer[i].transform.parent = lightRenderer.transform;
		}
        lightRenderer.transform.parent = parent.transform;
        IsActive =false;
	}
